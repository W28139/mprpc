...
class ResultCode final :
 ...
 public:
  ...
  enum : int {
    kEsrrmsgFieldNumber = 2,
    kErrcodeFieldNumber = 1,
  };
  // bytes esrrmsg = 2;
  void clear_esrrmsg();
  const std::string& esrrmsg() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_esrrmsg(ArgT0&& arg0, ArgT... args);
  std::string* mutable_esrrmsg();
  PROTOBUF_NODISCARD std::string* release_esrrmsg();
  void set_allocated_esrrmsg(std::string* esrrmsg);
  private:
  const std::string& _internal_esrrmsg() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_esrrmsg(const std::string& value);
  std::string* _internal_mutable_esrrmsg();
  public:
 ...
 private:
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr esrrmsg_;
    int32_t errcode_;
...
class GetFriendListsResponse final :
 ...
 public:
  ...
  enum : int {
    kFirendListFieldNumber = 3,
    kResultFieldNumber = 1,
    kSuccessFieldNumber = 2,
  };
  // repeated .fixbug.User FirendList = 3;
  int firendlist_size() const;
  private:
  int _internal_firendlist_size() const;
  public:
  void clear_firendlist();
  ::fixbug::User* mutable_firendlist(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
      mutable_firendlist();
  private:
  const ::fixbug::User& _internal_firendlist(int index) const;
  ::fixbug::User* _internal_add_firendlist();
  public:
  const ::fixbug::User& firendlist(int index) const;
  ::fixbug::User* add_firendlist();
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User > firendlist_;
    ::fixbug::ResultCode* result_;
    bool success_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
...
// bytes esrrmsg = 2;
inline void ResultCode::clear_esrrmsg() {
  _impl_.esrrmsg_.ClearToEmpty();
}
inline const std::string& ResultCode::esrrmsg() const {
  // @@protoc_insertion_point(field_get:fixbug.ResultCode.esrrmsg)
  return _internal_esrrmsg();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ResultCode::set_esrrmsg(ArgT0&& arg0, ArgT... args) {
 
 _impl_.esrrmsg_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:fixbug.ResultCode.esrrmsg)
}
inline std::string* ResultCode::mutable_esrrmsg() {
  std::string* _s = _internal_mutable_esrrmsg();
  // @@protoc_insertion_point(field_mutable:fixbug.ResultCode.esrrmsg)
  return _s;
}
inline const std::string& ResultCode::_internal_esrrmsg() const {
  return _impl_.esrrmsg_.Get();
}
inline void ResultCode::_internal_set_esrrmsg(const std::string& value) {
  
  _impl_.esrrmsg_.Set(value, GetArenaForAllocation());
}
inline std::string* ResultCode::_internal_mutable_esrrmsg() {
  
  return _impl_.esrrmsg_.Mutable(GetArenaForAllocation());
}
inline std::string* ResultCode::release_esrrmsg() {
  // @@protoc_insertion_point(field_release:fixbug.ResultCode.esrrmsg)
  return _impl_.esrrmsg_.Release();
}
inline void ResultCode::set_allocated_esrrmsg(std::string* esrrmsg) {
  if (esrrmsg != nullptr) {
    
  } else {
    
  }
  _impl_.esrrmsg_.SetAllocated(esrrmsg, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.esrrmsg_.IsDefault()) {
    _impl_.esrrmsg_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:fixbug.ResultCode.esrrmsg)
}
...
// bool success = 3;
inline void LoginRequest::clear_success() {
  _impl_.success_ = false;
}
inline bool LoginRequest::_internal_success() const {
  return _impl_.success_;
}
inline bool LoginRequest::success() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginRequest.success)
  return _internal_success();
}
inline void LoginRequest::_internal_set_success(bool value) {
  
  _impl_.success_ = value;
}
inline void LoginRequest::set_success(bool value) {
  _internal_set_success(value);
  // @@protoc_insertion_point(field_set:fixbug.LoginRequest.success)
}
...
// repeated .fixbug.User FirendList = 3;
inline int GetFriendListsResponse::_internal_firendlist_size() const {
  return _impl_.firendlist_.size();
}
inline int GetFriendListsResponse::firendlist_size() const {
  return _internal_firendlist_size();
}
inline void GetFriendListsResponse::clear_firendlist() {
  _impl_.firendlist_.Clear();
}
inline ::fixbug::User* GetFriendListsResponse::mutable_firendlist(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsResponse.FirendList)
  return _impl_.firendlist_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
GetFriendListsResponse::mutable_firendlist() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListsResponse.FirendList)
  return &_impl_.firendlist_;
}
inline const ::fixbug::User& GetFriendListsResponse::_internal_firendlist(int index) const {
  return _impl_.firendlist_.Get(index);
}
inline const ::fixbug::User& GetFriendListsResponse::firendlist(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsResponse.FirendList)
  return _internal_firendlist(index);
}
inline ::fixbug::User* GetFriendListsResponse::_internal_add_firendlist() {
  return _impl_.firendlist_.Add();
}
inline ::fixbug::User* GetFriendListsResponse::add_firendlist() {
  ::fixbug::User* _add = _internal_add_firendlist();
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListsResponse.FirendList)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
GetFriendListsResponse::firendlist() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListsResponse.FirendList)
  return _impl_.firendlist_;
}
