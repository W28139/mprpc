...
PROTOBUF_CONSTEXPR ResultCode::ResultCode(
    ...
    /*decltype(_impl_.esrrmsg_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
...
const uint32_t TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::ResultCode, _impl_.esrrmsg_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::LoginRequest, _impl_.success_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsResponse, _impl_.success_),
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsResponse, _impl_.firendlist_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::fixbug::ResultCode)},
  { 8, -1, -1, sizeof(::fixbug::LoginRequest)},
  { 17, -1, -1, sizeof(::fixbug::LoginResponse)},
  { 25, -1, -1, sizeof(::fixbug::GetFriendListsRequest)},
  { 32, -1, -1, sizeof(::fixbug::User)},
  { 41, -1, -1, sizeof(::fixbug::GetFriendListsResponse)},
};
...
const ::_pbi::DescriptorTable descriptor_table_test_2eproto = {
    false, false, 612, descriptor_table_protodef_test_2eproto,
    "test.proto",
...
ResultCode::ResultCode(const ResultCode& from)
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.esrrmsg_){}
    , decltype(_impl_.errcode_){}
    , /*decltype(_impl_._cached_size_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  _impl_.esrrmsg_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.esrrmsg_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_esrrmsg().empty()) {
    _this->_impl_.esrrmsg_.Set(from._internal_esrrmsg(), 
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          auto str = _internal_mutable_esrrmsg();
...
uint8_t* ResultCode::_InternalSerialize(
  ...
  // bytes esrrmsg = 2;
  if (!this->_internal_esrrmsg().empty()) {
    target = stream->WriteBytesMaybeAliased(
        2, this->_internal_esrrmsg(), target);
  }
...
void ResultCode::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (!from._internal_esrrmsg().empty()) {
    _this->_internal_set_esrrmsg(from._internal_esrrmsg());
  }
...
void ResultCode::InternalSwap(ResultCode* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.esrrmsg_, lhs_arena,
      &other->_impl_.esrrmsg_, rhs_arena
  );
...
GetFriendListsResponse::GetFriendListsResponse(const GetFriendListsResponse& from)
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.firendlist_){from._impl_.firendlist_}
    , decltype(_impl_.result_){nullptr}
    , decltype(_impl_.success_){}
    , /*decltype(_impl_._cached_size_)*/{}};
...
inline void GetFriendListsResponse::SharedCtor(
  ...
  (void)is_message_owned;
  new (&_impl_) Impl_{
      decltype(_impl_.firendlist_){arena}
    , decltype(_impl_.result_){nullptr}
    , decltype(_impl_.success_){false}
    , /*decltype(_impl_._cached_size_)*/{}
  };
...
inline void GetFriendListsResponse::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.firendlist_.~RepeatedPtrField();
  if (this != internal_default_instance()) delete _impl_.result_;
}
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_firendlist(), ptr);
            CHK_(ptr);
...
uint8_t* GetFriendListsResponse::_InternalSerialize(
  ...
  // repeated .fixbug.User FirendList = 3;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_firendlist_size()); i < n; i++) {
    const auto& repfield = this->_internal_firendlist(i);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
...
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetFriendListsResponse)
  ...
  // repeated .fixbug.User FirendList = 3;
  total_size += 1UL * this->_internal_firendlist_size();
  for (const auto& msg : this->_impl_.firendlist_) {
    total_size +=
...
void GetFriendListsResponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.firendlist_.MergeFrom(from._impl_.firendlist_);
  if (from._internal_has_result()) {
    _this->_internal_mutable_result()->::fixbug::ResultCode::MergeFrom(
        from._internal_result());
  }
...
void GetFriendListsResponse::InternalSwap(GetFriendListsResponse* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  _impl_.firendlist_.InternalSwap(&other->_impl_.firendlist_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(GetFriendListsResponse, _impl_.success_)
      + sizeof(GetFriendListsResponse::_impl_.success_)
